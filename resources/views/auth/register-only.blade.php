...
<head>
    ...
    <title>Register - Tour Sphere</title>
                ...
                <div class="w-full p-8 lg:p-12 relative overflow-hidden">
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="text-center mb-10 animate-fadeInUp">
                            ...
                            <h2 class="text-4xl font-bold bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 bg-clip-text text-transparent mb-3 animate-slideInDown">Join Tour Sphere</h2>
                            <p class="text-lg text-gray-600 font-medium animate-slideInUp">Create your account and start your adventure</p>
                        ...
                        <!-- Success Message -->
                        @if(session('success'))
                            <div class="mt-4 bg-green-50 border border-green-200 rounded-lg p-4 animate-fadeInUp">
                                <div class="flex">
                                    ...
                                    <div class="ml-3 flex-1">
                                        ...
                                        <div class="mt-3 pt-3 border-t border-green-200">
                                            <p class="text-xs text-green-600 mb-2">Ready to start your journey?</p>
                                            <a href="{{ route('login') }}" 
                                               class="inline-flex items-center text-xs font-medium text-green-700 hover:text-green-800 transition-colors">
                        ...
                        <form action="{{ route('register.post') }}" method="POST" class="space-y-6">
                            ...
                            <div class="animate-slideInLeft">
                                <label for="signupName" class="block text-sm font-semibold text-gray-700 mb-3">
                            ...
                            <div class="animate-slideInRight">
                                <label for="signupEmail" class="block text-sm font-semibold text-gray-700 mb-3">
                            ...
                            <!-- Phone Field -->
                            <div class="animate-slideInLeft">
                                <label for="signupPhone" class="block text-sm font-semibold text-gray-700 mb-3">
                            ...
                            <!-- Password Field -->
                            <div class="animate-slideInRight">
                                <label for="signupPassword" class="block text-sm font-semibold text-gray-700 mb-3">
                            ...
                            <div class="animate-slideInLeft">
                                <label for="signupPasswordConfirmation" class="block text-sm font-semibold text-gray-700 mb-3">
                                    <i class="fas fa-check-circle mr-2 text-purple-500"></i>Confirm Password
                                </label>
                                <div class="relative group">
                                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                        <svg class="h-5 w-5 text-purple-400 group-focus-within:text-purple-600 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="text-center animate-fadeInUp">
                            <div class="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 border border-blue-100">
                                <div class="flex items-center justify-center mb-3">
                                    ...
                                    <div class="text-left">
                                        <h3 class="text-lg font-semibold text-gray-800">Already have an account?</h3>
                                        <p class="text-sm text-gray-600">Welcome back to Tour Sphere</p>
                                    </div>
                                </div>
                                <a href="{{ route('login') }}" 
                                   class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-purple-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl">
