...
@section('title', 'Rock Climbing Adventures in Nepal')
@section('meta_description', 'Challenge yourself with Nepal\'s best rock climbing destinations. From beginner-friendly crags to advanced multi-pitch routes.')

@section('content')
<!-- Hero Section -->
<section class="relative h-96 bg-gradient-to-r from-gray-900 to-red-700 text-white">
    <div class="absolute inset-0 bg-black opacity-40"></div>
    <div class="relative z-10 container mx-auto px-4 h-full flex items-center">
        <div class="max-w-4xl">
            <h1 class="text-5xl font-bold mb-6">Rock Climbing Adventures</h1>
            <p class="text-xl mb-8">Challenge yourself with Nepal's best rock climbing destinations. From beginner-friendly crags to advanced multi-pitch routes.</p>
...
<!-- Rock Climbing Destinations Section -->
<section class="py-20 bg-gray-50">
    <div class="container mx-auto px-4">
        <div class="text-center mb-16">
            <h2 class="text-4xl font-bold text-gray-900 mb-4">Choose Your Climbing Adventure</h2>
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                From beginner-friendly crags to challenging multi-pitch routes, find your perfect climbing experience.
            </p>
        </div>

        <div class="space-y-16">
            @foreach($climbingData as $index => $destination)
            <div class="bg-white rounded-3xl shadow-2xl overflow-hidden {{ $index % 2 == 1 ? 'md:flex-row-reverse' : '' }} md:flex">
                ...
                <div class="md:w-1/2 p-8">
                    ...
                    <div class="flex gap-4">
                        ...
                        <a href="{{ route('booking.form', ['category' => 'rock-climbing', 'adventure_destination' => $destination['id']]) }}" 
                ...
                <div class="mt-8 pt-8 border-t border-gray-200">
                    <div class="grid md:grid-cols-3 gap-6">
                        <div class="text-center">
                            ...
                            <p class="text-sm text-gray-600">All climbing gear, ropes, harnesses, and safety equipment provided.</p>
                        </div>
                        <div class="text-center">
                            <div class="bg-green-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3">
                                <span class="text-2xl">👨‍🏫</span>
                            </div>
                            <h5 class="font-semibold text-gray-900 mb-2">Expert Instructors</h5>
                            <p class="text-sm text-gray-600">Certified climbing instructors with extensive safety training.</p>
                        </div>
                        <div class="text-center">
                            <div class="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3">
                                <span class="text-2xl">🏆</span>
                            </div>
                            <h5 class="font-semibold text-gray-900 mb-2">Achievement Certificate</h5>
                            <p class="text-sm text-gray-600">Certificate of completion and climbing achievement badge.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="text-center">
                ...
                <p class="text-gray-600 text-sm">All climbing gear is regularly inspected and certified for safety standards.</p>
            </div>
            <div class="text-center">
                ...
                <p class="text-gray-600 text-sm">Certified climbing instructors with extensive safety and rescue training.</p>
            </div>
            <div class="text-center">
                ...
                <p class="text-gray-600 text-sm">Comprehensive safety briefing and climbing techniques before each session.</p>
            </div>
            <div class="text-center">
                ...
                <p class="text-gray-600 text-sm">24/7 emergency support and rescue procedures in place.</p>
            </div>
        </div>
    </div>
</section>
...
<!-- CTA Section -->
<section class="py-20 bg-gradient-to-r from-gray-600 to-red-700 text-white">
    <div class="container mx-auto px-4 text-center">
        <h2 class="text-4xl font-bold mb-6">Ready for Your Climbing Adventure?</h2>
        <p class="text-xl mb-8 max-w-2xl mx-auto">
            Book your rock climbing experience today and challenge yourself on Nepal's best climbing routes.
        </p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ route('booking.form', ['category' => 'rock-climbing']) }}" 
