...
@section('title', 'Destination Booking - ' . $data['destination'])
...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-lg text-gray-600">Book your destination experience</p>
            <div class="mt-4 inline-flex items-center px-4 py-2 bg-purple-100 text-purple-800 rounded-lg">
                ...
                <div class="bg-gray-50 rounded-lg p-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium text-purple-600">Rs {{ number_format($data['price_per_person']) }}</span>
                        </div>
                        <div class="flex justify-between">
                        ...
                        <div class="border-t pt-2">
                            <div class="flex justify-between text-lg font-semibold">
                                ...
                                <span class="text-purple-600" id="total-price">-</span>
                            </div>
                        </div>
                    </div>
                </div>
